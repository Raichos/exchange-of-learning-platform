...
public class ExchangeOfLearningPlatformApplicationTests {
    ...
    @Test
    public void test08(){
        Article article = new Article().setUserArticle("何文海").setTitle("WEB后端架构").setArticlePath("/article/web.txt").setAnnounce(new Date());
        articleMapper.addArticle(article);
    }

    @Test
    public void test09(){
        //ArticleUtils.WriteStringToFile("aaa");
    ...
    public void test10(){
        String path = Class.class.getClass().getResource("/").getPath();
        path = path.substring(1, path.indexOf("exchange-of-learning-platform") + "exchange-of-learning-platform".length() + 1) + "src/main/resources/static";
        path += articleService.findArticlePathByUserArticle("aaaaaa", "fffffffffff");
        System.out.println("path"+path);

        ArticleUtils.readArticleByPath(path);
    }

    @Test
    public void test11(){
        List<String> allTitle = articleService.findAllTitle();
        System.out.println(allTitle);
    }

    @Test
    public void test12(){
        String article = "<html><head><style type=\"text/css\">.view{padding:0;word-wrap:break-word;cursor:text;height:90%;}body{margin:8px;font-family:sans-serif;font-size:16px;}p{margin:5px 0;}</style><link rel=\"stylesheet\" type=\"text/css\" href=\"http://localhost:8080/static/ueditor/themes/iframe.css\"><style id=\"tablesort\">table.sortEnabled tr.firstRow th,table.sortEnabled tr.firstRow td{padding-right:20px;background-repeat: no-repeat;background-position: center right;   background-image:url(http://localhost:8080/static/ueditor/themes/default/images/sortable.png);}</style><style id=\"table\">.selectTdClass{background-color:#edf5fa !important}table.noBorderTable td,table.noBorderTable th,table.noBorderTable caption{border:1px dashed #ddd !important}table{margin-bottom:10px;border-collapse:collapse;display:table;}td,th{padding: 5px 10px;border: 1px solid #DDD;}caption{border:1px dashed #DDD;border-bottom:0;padding:3px;text-align:center;}th{border-top:1px solid #BBB;background-color:#F7F7F7;}table tr.firstRow th{border-top-width:2px;}.ue-table-interlace-color-single{ background-color: #fcfcfc; } .ue-table-interlace-color-double{ background-color: #f7faff; }td p{margin:0;padding:0;}</style><style id=\"list\">ol,ul{margin:0;pading:0;width:95%}li{clear:both;}li.list-cn-1-0{background-image:url(http://bs.baidu.com/listicon/list-cn-1-0.gif)}\n" +
                ...
                ".list-paddingleft-3{padding-left:60px}</style><style id=\"pagebreak\">.pagebreak{display:block;clear:both !important;cursor:default !important;width: 100% !important;margin:0;}</style><style id=\"pre\">pre{margin:.5em 0;padding:.4em .6em;border-radius:8px;background:#f8f8f8;}</style><style id=\"loading\">.loadingclass{display:inline-block;cursor:default;background: url('http://localhost:8080/static/ueditor/themes/default/images/loading.gif') no-repeat center center transparent;border:1px solid #cccccc;margin-left:1px;height: 22px;width: 22px;}\n" +
                ".loaderrorclass{display:inline-block;cursor:default;background: url('http://localhost:8080/static/ueditor/themes/default/images/loaderror.png') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;}</style><style id=\"anchor\">.anchorclass{background: url('http://localhost:8080/static/ueditor/themes/default/images/anchor.gif') no-repeat scroll left center transparent;cursor: auto;display: inline-block;height: 16px;width: 15px;}</style><style type=\"text/css\">body{background-color:#ffffff; background-image:; background-repeat:repeat; background-position:0% 0%; height:427px; }</style> </head><body ><p>fffffffffffffffffffffffffffff<img src=\"/static/image/20190616/1560649315915007460.jpg\" title=\"1560649315915007460.jpg\" alt=\"ae40953a83310b5f0c5221e40b6a485b.jpg\"/></p></body></html>";
