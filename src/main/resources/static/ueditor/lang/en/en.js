...
UE.I18N['en'] = {
    ...
    'loadconfigError': 'Get server config errorpage.',
    'loadconfigFormatError': 'Server config format errorpage.',
    'loadconfigHttpError': 'Get server config http errorpage.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the config!",
        'uploadErrorMsg':"Upload errorpage,please check your server environment! "
    },
    'insertcode':{
        'as3':'ActionScript 3',
        'bash':'Bash/Shell',
    ...
    'insertvideo':{
        ...
        'fileTypeError':'File type errorpage！',
        'unknownError':'Unknown errorpage！',
        'fileUploading':'Uploading,please wait...',
        'cancelUpload':'Cancel upload',
        'netError':'Network errorpage',
        'failUpload':'Upload failed',
        'serverIOError':'Server IO errorpage！',
    ...
    wordimage:{
        ...
        netError:"Network errorpage! Please try again!",
