document.write("<!DOCTYPE html>\n" +
    ...
    ".loaderrorclass{display:inline-block;cursor:default;background: url('http://localhost:8080/static/ueditor/themes/default/images/loaderror.png') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;}</style><style id=\"anchor\">.anchorclass{background: url('http://localhost:8080/static/ueditor/themes/default/images/anchor.gif') no-repeat scroll left center transparent;cursor: auto;display: inline-block;height: 16px;width: 15px;}</style></head><body class=\"view\" contenteditable=\"true\" spellcheck=\"false\" style=\"overflow-y: hidden; height: 617px; cursor: text;\"><p>v-for绑定数组数据渲染时</p><pre class=\"brush:java;toolbar:false\">arr[index] = newVal&nbsp;</pre><p><br></p><p>形式改变数组值不会重新渲染视图，原因是vue无法监听到复杂数据类型内部数据变化，要使用</p><pre class=\"brush:java;toolbar:false\">Vue.set( target, key, value )</pre><p><br></p><p>在methods中 ，可写为</p><pre class=\"brush:java;toolbar:false\">this.$set( target, key, value)</pre><p><img src=\"http://localhost:8080/static/image/20190611/1560223779516012390.jpg\" title=\"1560223779516012390.jpg\" _src=\"/static/image/20190611/1560223779516012390.jpg\" alt=\"???.jpg\"></p><p>方式改变数据</p></body></html>");